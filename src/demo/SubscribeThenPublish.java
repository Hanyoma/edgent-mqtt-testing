 ...
 */
public class SubscribeThenPublish {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SubscribeThenPublish subscriber = new SubscribeThenPublish(args[0]);
        subscriber.run();
    }
     ...
     */
    SubscribeThenPublish(String mqttPropsPath) throws Exception {
        props = new Properties();
        props.load(Files.newBufferedReader(new File(mqttPropsPath).toPath()));
        //TODO: replace hard-coded topic with topic field in properties file
        topic = "mqttSampleTopic2";
    }
